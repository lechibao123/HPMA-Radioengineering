...
semilogy(L_arr,P_out_HPMA_1,'-o','Linewidth',1,'MarkerFaceColor',green1,'MarkerSize',8,'Color',green1); hold on
semilogy(L_arr,P_out_HPMA_2,'-s','Linewidth',1,'MarkerFaceColor',pink1,'MarkerSize',8,'Color',pink1);
semilogy(L_arr,P_out_NOMA_1,'-d','Linewidth',1,'MarkerFaceColor',blue1,'MarkerSize',8,'Color',blue1);
semilogy(L_arr,P_out_NOMA_2,'-v','Linewidth',1,'MarkerFaceColor','m','MarkerSize',8,'Color','m');

% semilogy(L_arr,P_out_HPMA_1_sim,'k.','Linewidth',1,'MarkerSize',9);
% semilogy(L_arr,P_out_HPMA_2_sim,'k.','Linewidth',1,'MarkerSize',9);
% semilogy(L_arr,P_out_NOMA_1_sim,'k.','Linewidth',1,'MarkerSize',9);
% semilogy(L_arr,P_out_NOMA_2_sim,'k.','Linewidth',1,'MarkerSize',9);



xlabel('$L$ [m]','Interpreter','latex','fontsize',15);
